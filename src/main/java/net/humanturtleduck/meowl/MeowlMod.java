package net.humanturtleduck.meowl;
...
import net.humanturtleduck.meowl.entity.client.MeowlRenderer;
...
@Mod(MeowlMod.MOD_ID)
public class MeowlMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "meowl";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    public MeowlMod(FMLJavaModLoadingContext context) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModeTabs.SPAWN_EGGS) {
            event.accept(ModItems.MEOWL_SPAWN_EGG);
